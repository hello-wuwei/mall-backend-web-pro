...
const Perfected = (props:IProps) => {
  ...
  return (
    <div>
      <div>
        <Button type="primary" style={{ marginRight: 15 }} disabled={!codeList.length} onClick={() => onBatch(codeList, 3, successCallback)}>批量上架</Button>
        <Button type="primary" disabled={!codeList.length} onClick={() => onBatch(codeList, 6, successCallback)}>批量不展示</Button>
      </div>
